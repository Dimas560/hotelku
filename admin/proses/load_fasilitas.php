...
<div class="container mt-2" id="data_fasilitas">
  ...
  <div class="d-flex justify-content-between d-flex flex-row-reverse">
    ...
    <div class="form-floating mb-2 mt-3">
      <button type="button" onclick="add_modal_fasilitas()" class="btn btn-outline-light">Tambah Fasilitas</button>
    </div>
  </div>

  <!-- Desain Box Tabel Fasilitas -->
              ...
              ?>
                  <tr>
                    ...
                    <td class="text-center">
                      ...
                      <a href="#" data-id="" class="btn btn-primary" onClick="show_modal_fasilitas_kamar(this.id, 0)" id="<?php echo $row["id"]; ?>">Ubah</a>
                      <a href="#" data-id="" class="btn btn-danger" onClick="delete_fasilitas_kamar(this.id)" id="<?php echo $row["id"]; ?>">Hapus</a>
                    </td>
                  </tr>
              <?php
                }
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    $('#cari_fasilitas').on('keyup', function() {
